...
// Small dependency-free icon set. Each accepts a `size` prop (defaults to 18).
...
export const XIcon = ({ size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M18.24 2H21l-6.5 7.43L22.2 22h-6.72l-5.26-6.86L4.14 22H1.36l7-8.01L1.1 2h6.9l4.76 6.3L18.24 2Zm-1.18 18.17h1.86L7.02 3.75H5.02l12.04 16.42Z" />
  </svg>
);
